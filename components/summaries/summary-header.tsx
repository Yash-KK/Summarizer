    ...
    <div className="flex gap-4 mb-4 justify-between">
      <div className="space-y-6">
        <div className="">
          <Badge
            variant={"secondary"}
            className="relative px-4 py-1.5 text-sm font-medium bg-white/80 backdrop-blur-xs rounded-full hover:bg-white/90 transform-a;; duration-200 shadow-xs hover:shadow-md"
          >
